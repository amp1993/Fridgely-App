...
const categoryOptions = [
    ...
    { value: 'Cereals & Granola', label: 'Cereals & Granola' },
...
//     { value: 'piece', label: 'piece', category: 'Misc' }
// ];
const categoryUnits = {
    "categories": [
        {
...
export { categoryOptions, unitOfMeasureOptions, categoryUnits };
